...
if($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    if(count($error_text)>0) {
        ...
        $puntor_id=isset($_POST['puntor_id'])?$_POST['puntor_id']:'null';

        $sql="UPDATE puntoret SET emri='$emri',mbiemri='$mbiemri',pozita='$pozita',departamenti='$departamenti' WHERE id='$puntor_id'";
